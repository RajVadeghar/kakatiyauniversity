    ...
    <div
      ...
      <div className="mx-auto flex h-full w-screen items-center justify-between px-5 md:max-w-screen-2xl md:px-0 xl:max-w-screen-xl">
        <div className="w-full py-5">
          <section className="relative mx-auto flex w-full max-w-screen-md flex-col items-center gap-x-16 gap-y-8 border-[0.2px] bg-white p-11 shadow-sm md:flex-row md:items-start">
            {message && (
            ...
            {(loggedInUser ||
              ...
              <button
                ...
                className="absolute right-3 top-3 h-7 cursor-pointer font-bold text-gray-400">
                {isEditing ? (
          ...
          {session.user.role === UserRole.Admin &&
            ...
            currentUser && (
              <div className="animate-slide-up">
                <p className="mx-auto my-10 w-full max-w-screen-md text-xl font-medium">
                            ...
                            <button
                              onClick={() => {
                                updateUser({
                                  ...
                                  .then(() => {
                                    const rest =
                                      unapprovedFacultyDetails.filter(
